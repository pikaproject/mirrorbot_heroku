...
'''
        ...
        text = f"Not Authorized user, join our group to use this bot"
        if config_dict['PICS']:
...
help_string = '''
<b>MikaMirror</b> - The Ultimate Telegram MIrror-Leech Bot to Upload Your File & Link in Google Drive & Telegram
